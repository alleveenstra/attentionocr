...
if __name__ == "__main__":
    ...
    train_data = synthetic_data_generator(vec, epoch_size=100, augment=True)
    test_data = synthetic_data_generator(vec, epoch_size=100)
    ...
    model.fit_generator(train_gen, epochs=10, batch_size=64, validation_data=test_gen, validate_every_steps=1000)
